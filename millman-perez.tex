...
%this life-cycle in a way that naturally leads to reproducible outcomes.
%
...
%rather than the awkward and cumbersome one.
...
Unlike traditional open source communities, the scientific community has
a great need for communicating computational results to one another. Whether
...
convery their computational work to others.
We will first briefly describe the existing tools for literate programming as
the backdrop against which we will introduce a contrasting approach that we
refer to as ``literate computing''.  We argue that this approach is a better
fit to the needs of reproducibility in computational research and will present
the IPython notebook as an example implementation.
