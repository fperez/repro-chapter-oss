...
datasets can be used to collect at least validation statistics to indicate
how much trust may be placed on the published analysis.  Fortunately, for
the large of bulk of research, these issues are irrelevant.
