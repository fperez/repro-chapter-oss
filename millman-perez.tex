...
greatly enhance our ability to achieve reproducible outcomes.\footnote{We take
  ...
  communities.}  Open source software development uses public fora for most
...
sharing code, track the authorship of contributions. All of this ensures
that open collaboration does not dilute the recognition of any
individual developer and allows for a meritocracy of contributors to emerge,
while enabling highly effective collaboration.

As we seek to learn how the open source practice can inform our scientific
work, we recognize that the ideal of scientific reproducibility is by necessity
a reality of shades. We see a gradation from a pure mathematical result whose
...
analysis.  But again, alternatives exist: it should be possible to validate
scaled versions of the largest problems run independently, against scaled
specimens created on the supercomputers for this purpose, and sub-sampled
datasets can be used to collect at least validation statistics to inform us
how much trust we may place on the published analysis.  Fortunately, for
the large of bulk of research, these issues are not the case.
