...
\fperez{Would you take a stab at turning this into a couple of sentences:
- Newer version control systems such as Git and Mercurial provide 
- cryptographic hash (SHA1)... data integrity, git-annex
}

\fbox{
    \parbox[c]{12cm}{
Pervasive version control: research codes should be developed, while
...
As your research project progresses the amount of code and data that you need
to manage will grow. At the outset, it may be possible to mentally or manually
keep track of all the components of your project. But, eventually, you will need
tools and procedures in place to take care of these details for you.
...
Collaboration is an essential aspect of the scientific enterprise.

Scientific research is inherently collaborative enterprise.
...
\paragraph{ {\bf IPython}} \fperez{why the change to paragraph?}
...
the last stage of the cycle we outlined earlier.  We will increase our chance
that the next generation of scientists adopts improved reproducibility
practices if we educate them with the same tools that we use for everyday
research, and a couple of modern efforts that aim to bring improved
computational literacy to scientific research have adopted the IPython
notebook.  The Software Carpentry
project\footnote{\url{http://software-carpentry.org}}, funded by
the Alfred P. Sloan Foundation, is a project led by Greg Wilson at the Mozilla
Foundation that 
