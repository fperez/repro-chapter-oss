...
at present and will become disastorous if the situation is not dealt with
directly. 
...
are confronted with an avalanche of quatitative data.  All scientists must now
do real computing.  As computers continue to increase in compuational power and
...
pancea in itself; the rigor, openness, culture of validation, collaboration and
other aspects of science must become a routine part of our compuational practices.

\parasep

In the next section, we share some essential lessons we've learned from our
...
Over the last decade, we've had the privelege of participating in a community
of scientists, researchers, and engineers to help create a powerful stack of
tools for scientific computing written in Python.  Among high-level open source
programming languages, Python is today the leading tool for general-purpose
source scientific computing (along with R for statistics), finding wide
adoption across research disciplines, education and industry and being a core
infrastructure tool at institutions such as CERN and the Hubble Space Telescope
Science Institute \cite{millman2011python,Perez2011,ganga09,SST}.

Participation in this community has taught us several several important lessons.
...
\item On programming courses: ``No intelectual content.''
...
goods with them.  Unfamilar with modern industrial manufacturing processes, the
...
the scientific journal and review process have evolved over time as both science and the scientific community have evolved
    ...
    the origin of the scientific journal
        ...
        journals such as the Society's Philosphical Transactions (1665) edited by Henry Oldenburg appeared
...
dashboard. automated testing on code checkin
