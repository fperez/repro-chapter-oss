...
In practice, it is impossible not to use some system for managing
different versions of your work. While writing a paper, you need to
keep track of drafts, proofs, and camera-ready 

code is adapted, improved, and refactored

writing is corrected, revised, and expanded

data is augmented and curated
