...
\mref{sweave}.  Sweave is one of the central elements of the Bioconductor
...
In recent years, a new entrant to the R community that is gaining very rapid
adoption is the Knitr package \mref{knitr}.  Knitr can be seen as a highly
...
The tools described in the previous section for literate programming are mature
