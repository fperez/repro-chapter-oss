...
\item {\bf Failing Test.} Before implementing any new functionality, first
...
and the specifics of the languauge you are working in.

Unlike prose, readability in programming includes not just the code itself, but
