...
Northern Arizona, and Justin Riley at MIT who created the StarCluster system
...
editing the code collaboratively, turn this prototype into a set of production
notebooks that would execute the analysis in parallel using multiple Amazon
servers.  The net result was that the team took the prototype from start to
production in a single day of collaborative editing; this resulted


\fperez{add ISME story here to wrap it up?}

% Software carpentry, Berkeley bootcamps.
