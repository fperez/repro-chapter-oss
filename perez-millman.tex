...
section, we discuss practices and tools that become essential in
...
There are tenative new directions, dead ends, and alternative
routes.
...
Microsoft Words' Track Changes functionality).  While these solutions don't
require learning any new tools, they are cumbersome and prone to failure.

Since this is such a common problem, programmers have developed general
purpose software tools to help track the various versions of
their work. While many of these tools provide similar functionality, we
will illustrate the basic features using \texttt{git}.

\begin{itemize}

\item terminology:  repository, commit, checkout, branch, merge, conflict, resolve, hash (SHA1)... 

\item checking in specific version with comment
